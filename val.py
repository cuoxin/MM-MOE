...
if __name__ == '__main__':
    model = YOLO(R'/root/autodl-tmp/MM-MOE/runs/YOLOv12/myDualData_I_RGB/weights/best.pt')
    model.val(data=r'/root/autodl-tmp/MM-MOE/ultralytics/cfg/datasets/myDualDataV.yaml',
              split='val',
              imgsz=640,
              batch=16,
