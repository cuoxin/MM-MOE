...
if __name__ == '__main__':
    model = YOLO(R'/root/autodl-tmp/MM-MOE/runs/test_640/MMMOEV1_0_640/weights/best.pt')
    model.val(data=r'/root/autodl-tmp/MM-MOE/ultralytics/cfg/datasets/myDualDataV_640.yaml',
              split='test',
              imgsz=640,
              batch=16,
